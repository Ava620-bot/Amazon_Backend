...
// static files serving our frontend
// app.use(express.static(path.join(__dirname, "./amazon_2.0/build")));
// app.get("*", function (req, res) {
//   res.sendFile(
//     path.join(__dirname, "./amazon_2.0/build/index.html"),
//     function (err) {
...
app.use(express.static(path.join(__dirname, './amazon_2.0/build')));
app.get('*', function(req, res){
    res.sendFile(path.join(__dirname, './amazon_2.0/build/index.html'));
});
